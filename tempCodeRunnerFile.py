...
if app_mode == 'Tree':
    ...
    with col1:
        with st.container():
            st.write("Tree Pose")
            image = Image.open('D:/Yoga-Pose-Detection/Tree Yoga Pose.jpg')  # Update with the new image path
    ...
    with col2:
        ...
        if start:
            ...
            FRAME_WINDOW = st.image([])  # Display frame in Streamlit
            ...
            if not cap.isOpened():
                ...
                with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
                    while cap.isOpened():
                        ...
                        FRAME_WINDOW.image(cv2.cvtColor(image, cv2.COLOR_BGR2RGB))  # Update the Streamlit image display
...
if app_mode == 'Mountain':
    ...
    with col1:
        with st.container():
            ...
            image = Image.open('D:/Yoga-Pose-Detection/Mountain Yoga Pose.jpg')  # Update with the new image path
...
if app_mode == 'Warrior2':

    col1, col2 = st.columns([2, 3])
    with col1:
        with st.container():
            st.write("Warrior 2 Pose")
            image = Image.open('D:/Yoga-Pose-Detection/Warrior Yoga Pose.jpg')  # Update with the new image path
            st.image(image, caption='Warrior 2 Pose')
    with col2:
        st.write("Webcam Live Feed")
